                ...
                <form action="{{ route('landing.contact') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="subject" 
                            ...
                            <option value="sales" {{ old('subject') == 'sales' ? 'selected' : '' }}>Consulta comercial</option>
                            <option value="support" {{ old('subject') == 'support' ? 'selected' : '' }}>Soporte técnico</option>
                            <option value="demo" {{ old('subject') == 'demo' ? 'selected' : '' }}>Solicitar demo</option>
                            <option value="partnership" {{ old('subject') == 'partnership' ? 'selected' : '' }}>Alianzas estratégicas</option>
                ...
                <div class="bg-indigo-50 rounded-xl p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-indigo-600">< 24 horas</span>
                        </div>
                        <div class="flex justify-between">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-lg p-6 shadow-sm">
                ...
                <p class="text-gray-600">
                    Soporte por email, chat y teléfono. Planes superiores incluyen soporte prioritario y account manager.
                </p>
            </div>
        </div>
    </div>
