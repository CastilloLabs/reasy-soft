                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex">
                                <input type="text" id="subdomain" name="subdomain" required placeholder="mi-negocio"
                                    pattern="[a-zA-Z0-9-]+"
                                    class="flex-1 px-4 py-3 border border-gray-300 rounded-l-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                <span
                                    class="px-4 py-3 bg-gray-100 border border-l-0 border-gray-300 rounded-r-lg text-gray-600">
                                    .reasy.com
                                </span>
                            </div>
                            <p class="mt-1 text-sm text-gray-500">Esta será la dirección web de tu negocio. Solo letras,
                                números y guiones.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-3 text-sm text-gray-600">
                            Acepto los <a href="{{ route('landing.terms') }}"
                                class="text-indigo-600 hover:text-indigo-500">términos de servicio</a>
                            y la <a href="{{ route('landing.privacy') }}"
                                class="text-indigo-600 hover:text-indigo-500">política de privacidad</a> *
                        </label>
                    </div>
