    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
            ...
            <ul>
                ...
                <li><strong>Información de facturación:</strong> datos de tarjeta de crédito, dirección de facturación</li>
            ...
            <ul>
                ...
                <li><strong>Consentimiento:</strong> para comunicaciones de marketing (puede retirar el consentimiento)</li>
            ...
            <p>
                ...
                su cuenta, eliminaremos sus datos dentro de 90 días, salvo que tengamos una obligación legal de conservarlos.
            </p>
            ...
            <h2>15. Contacto</h2>
            <p>
                Si tiene preguntas sobre esta Política de Privacidad o nuestras prácticas de datos, contacte con nosotros:
            </p>
            <ul>
