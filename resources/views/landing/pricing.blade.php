            ...
            <div class="space-y-8">
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <p class="text-gray-600">
                        Sí, ofrecemos 30 días de prueba gratuita en todos nuestros planes. No se requiere tarjeta de crédito
                        para comenzar.
                    </p>
                </div>
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <p class="text-gray-600">
                        Absolutamente. Puedes upgrader o downgrader tu plan cuando quieras. Los cambios se aplican
                        inmediatamente.
                    </p>
                </div>
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <p class="text-gray-600">
                        Te notificaremos cuando te acerques a los límites. Si los excedes, te sugeriremos upgrader a un plan
                        superior.
                    </p>
                </div>
                ...
                <div class="border-b border-gray-200 pb-8">
                    ...
                    <p class="text-gray-600">
                        Sí, puedes cancelar tu suscripción en cualquier momento sin penalizaciones. Tu cuenta permanecerá
                        activa hasta el final del período facturado.
                    </p>
                </div>
